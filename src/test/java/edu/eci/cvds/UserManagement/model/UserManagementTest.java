...
public class UserManagementTest {
    ...
    @Test
    public void testRoleIsAlwaysAdministrator() {
    ...
    @Test
    public void testUserSetAndGetUserName() {
    ...
    @Test
    public void testUserSetAndGetPassword() {
        User user = new User("1", "testUser", "password123");
    ...
    @Test
    public void testUserSetAndGetRole() {
        User user = new User("1", "testUser", "password123");
        user.setRole("admin");
    ...
    @Test
    public void testStudentCreationAndRole() {
    ...
    @Test
    public void testStudentPasswordEncryption() {
        String studentId = "12345";
    ...
    @Test
    public void testStudentSetAndGetCourse() {
    ...
    @Test
    public void testStudentGetResponsibleDocument() {
        Student student = new Student("12345", "John Doe", "987654321", "ID", "Math", "654321");
    ...
    @Test
    public void testDetermineGradeNameWithPrefixes() {
